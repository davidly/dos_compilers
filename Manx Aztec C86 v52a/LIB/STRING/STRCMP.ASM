...
;Copyright (C) 1983 by Manx Software Systems
	...
	procdef	strcmp,<<str1,ptr>,<str2,ptr>>
	cld
	push	si
	push	di
	pushds
...
ifndef LONGPTR
	...
	ldptr	di,str2
ncmploop:
	lodsw			; load *(es:si) into ax
	scasw			; compare to *(ds:di)
	jne	word_notequal
	test	al,al		; done with string?
	jz	equal		; yup, they're EQUAL
	test	ah,ah		; done with string?
	jnz	ncmploop	; nope, keep going
equal:
	sub	ax,ax
done:
	popds
