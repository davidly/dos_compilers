/*
   BSAVEINC.c (C) Copyright Bill Buckels 1990-2008. All rights reserved.
...
char *argv[];
{
 ...
 default: printf("BSAVEINC(C) Copyright Bill Buckels 1990-2008.\nAll rights reserved.\n");
          printf(
