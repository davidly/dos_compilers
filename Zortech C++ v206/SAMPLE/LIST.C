...
/* $Header: list.c,v 1.8 88/05/27 15:37:57 bright Locked $ */
/* Copyright (C) 1986-1989 by Northwest Software	*/
/* All Rights Reserved					*/
/* Written by Walter Bright				*/

#if VAX11C
#define __FILE__ "list.c"
#endif
...
{   list_t list;
    ...
    {	nlist++;
#ifdef MEM_DEBUG
	list = (list_t) mem_calloc_debug(sizeof(struct LIST),file,line);
#else
	list = (list_t) mem_malloc(sizeof(struct LIST));
#endif
    }
    return list;
}
...
void *ptr;
{
    list_append_debug(plist,ptr,__FILE__,__LINE__);
}
